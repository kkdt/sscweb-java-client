...
import gov.nasa.gsfc.spdf.ssc.BFieldModelOptions;
import gov.nasa.gsfc.spdf.ssc.BFieldModelParameters;
...
import gov.nasa.gsfc.spdf.ssc.CoordinateOptions;
...
import gov.nasa.gsfc.spdf.ssc.DistanceFromOptions;
import gov.nasa.gsfc.spdf.ssc.DistanceUnits;
import gov.nasa.gsfc.spdf.ssc.ExternalBFieldModel;
import gov.nasa.gsfc.spdf.ssc.FileResult;
import gov.nasa.gsfc.spdf.ssc.FilteredCoordinateOptions;
import gov.nasa.gsfc.spdf.ssc.FootpointRegion;
import gov.nasa.gsfc.spdf.ssc.FormatOptions;
import gov.nasa.gsfc.spdf.ssc.GraphRequest;
import gov.nasa.gsfc.spdf.ssc.GroundStationDescription;
import gov.nasa.gsfc.spdf.ssc.Hemisphere;
import gov.nasa.gsfc.spdf.ssc.HemisphereOptions;
import gov.nasa.gsfc.spdf.ssc.InternalBFieldModel;
import gov.nasa.gsfc.spdf.ssc.LatLonFormat;
import gov.nasa.gsfc.spdf.ssc.LocationFilter;
import gov.nasa.gsfc.spdf.ssc.LocationFilterOptions;
import gov.nasa.gsfc.spdf.ssc.MapProjection;
import gov.nasa.gsfc.spdf.ssc.MapProjectionGraphOptions;
import gov.nasa.gsfc.spdf.ssc.MappedRegionFilterOptions;
import gov.nasa.gsfc.spdf.ssc.OrbitGraphOptions;
import gov.nasa.gsfc.spdf.ssc.OutputOptions;
import gov.nasa.gsfc.spdf.ssc.PolarMapOrientation;
import gov.nasa.gsfc.spdf.ssc.ProjectionCoordinateSystem;
import gov.nasa.gsfc.spdf.ssc.RegionFilterOptions;
import gov.nasa.gsfc.spdf.ssc.RegionOptions;
import gov.nasa.gsfc.spdf.ssc.Result;
...
import gov.nasa.gsfc.spdf.ssc.SpaceRegion;
import gov.nasa.gsfc.spdf.ssc.SpaceRegionsFilterOptions;
import gov.nasa.gsfc.spdf.ssc.SpaseObservatoryDescription;
import gov.nasa.gsfc.spdf.ssc.TimeFormat;
import gov.nasa.gsfc.spdf.ssc.TimeSeriesGraphOptions;
import gov.nasa.gsfc.spdf.ssc.Trace;
import gov.nasa.gsfc.spdf.ssc.ValueOptions;
...
public class WsExample {
    ...
    public static void main(String args[]) 
        ...
        String wsdlLocation = args.length == 1 ? args[0] 
